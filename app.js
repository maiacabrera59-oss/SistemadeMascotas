...
function actualizarResumen() {
    ...
    let vacunadas =
        mascotas.filter((mascota) => mascota.vacunada);
    ...
    if (totalMascotas) {
        ...
        totalMascotas.innerHTML =
            "Total de mascotas: " + mascotas.length;
    }

    if (totalVacunadas) {

        totalVacunadas.innerHTML =
            "Vacunadas: " + vacunadas.length;
    }

    if (totalNoVacunadas) {

        totalNoVacunadas.innerHTML =
            "No vacunadas: " + noVacunadas.length;
    }
}
